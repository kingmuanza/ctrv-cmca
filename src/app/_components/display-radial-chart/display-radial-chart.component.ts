...
@Component({
  selector: 'app-display-radial-chart',
  templateUrl: './display-radial-chart.component.html',
  styleUrls: ['./display-radial-chart.component.scss']
})
export class DisplayRadialChartComponent implements OnInit, OnChanges {
  ...
  private dessinerGraphes(annee: number) {
    ...
    let ctxRadial: any = document.getElementById('radial-chart');
