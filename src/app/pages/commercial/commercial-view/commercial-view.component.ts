...
export class CommercialViewComponent implements OnInit {
  ...
  private dessinerGraphes(annee: number) {
    ...
    let ctx: any = document.getElementById('commercial-bar');
    let ctxRadial: any = document.getElementById('commercial-radial');
    let ctxCirculaire: any = document.getElementById('commercial-circulaire');
